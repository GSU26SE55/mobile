...
// Same sandboxing as BlogContent: CSP blocks all scripts/frames, only allows
// https + data images and inline styles from this document itself. Combined
// with javaScriptEnabled={false} below → article HTML from the BE rich-text
// editor cannot execute anything.
const CSP =
...
<style>
  ...
  h1, h2, h3 { font-weight: 700; color: ${Colors.text}; }
...
export function KbContent({ html }: Props) {
